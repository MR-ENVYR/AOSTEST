...
import 'package:style_of_agent/stylist/profile_filling_2.dart';
...
class StyleProfileFilling extends StatefulWidget {
  FirebaseUser user;
  StyleProfileFilling({this.user});
  @override
  _StyleProfileFillingState createState() => _StyleProfileFillingState();
}

class _StyleProfileFillingState extends State<StyleProfileFilling> {
...
//                                    style: inputStyle,
                            ...
                            TextFormField(
                              ...
                              validator: (String val) {
                                val = val.trim();
                                if (val.isEmpty) {
                                  return "Describe your biography";
                                }
                                return null;
                              },
                              focusNode: bioNode,
                                  ...
                                  Navigator.push(
                                      ...
                                      PageTransition(
                                          type: PageTransitionType
                                              .rightToLeftWithFade,
                                          child: StyleProfileFillingPart2(
                                            userModel: userPart1,
                                            image: _image,
                                            uid: uid,
                                          )));
