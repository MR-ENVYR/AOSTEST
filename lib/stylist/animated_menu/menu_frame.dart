...
import 'package:style_of_agent/stylist/animated_menu/about.dart';
import 'package:style_of_agent/stylist/animated_menu/faq.dart';
import 'package:style_of_agent/stylist/animated_menu/menu_screen.dart';
import 'package:style_of_agent/stylist/animated_menu/contact_us.dart';
import 'package:style_of_agent/stylist/animated_menu/dashboard.dart';
import 'package:style_of_agent/stylist/animated_menu/policy.dart';
import 'package:style_of_agent/stylist/animated_menu/profile.dart';
import 'package:style_of_agent/stylist/animated_menu/rate_us.dart';
import 'package:flutter/material.dart';
import 'package:style_of_agent/model/usermodel.dart';
import 'package:style_of_agent/utils/utils.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

class StyleMenuFrame extends StatefulWidget {
  int index;
  bool animate;
//  FirebaseUser user;
  String uid;
  StyleMenuFrame({this.index = -1, this.animate = false, this.uid});
  @override
  _StyleMenuFrameState createState() => _StyleMenuFrameState();
}

class _StyleMenuFrameState extends State<StyleMenuFrame>
...
//        uid = id;
  ...
  List<Widget> finalStack() {
    ...
    stackToReturn.add(StyleMenuScreen(
